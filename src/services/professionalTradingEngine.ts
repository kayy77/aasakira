  ...
  private parseInstitutionalResponse(response: string, symbol: string, price: number, session: string): ProfessionalSignal {
    try {
      ...
      return {
        ...
        confidence: analysis.conviction_level || 75,
        quality: analysis.institutional_grade || 'PROFESSIONAL',
        ...
        institutionalGrade: analysis.institutional_grade || 'PROFESSIONAL',
        convictionScore: analysis.conviction_level || 75,
        positionSizeRec: analysis.position_size_rec || '1.0%',
