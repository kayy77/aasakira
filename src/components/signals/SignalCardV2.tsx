  ...
  return (
    <>
      <motion.div
        ...
        className="relative"
      >
        <Card className="bg-gradient-to-br from-gray-950 to-gray-900 border border-pink-500/20 relative overflow-hidden backdrop-blur-sm">
          ...
          <CardHeader className="pb-3 relative z-10">
            <div className="flex items-center justify-between">
              ...
              <Badge className={`bg-gradient-to-r ${confidenceLevel.color} text-black font-bold px-3 py-1`}>
            ...
            <div className="mt-3">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-400 font-serif">Confluence Score: {voteCount}/6</span>
                <span className="text-sm font-bold text-pink-300">Confidence Level: {signalDNA.confidence}%</span>
              </div>
              <div className="relative">
                <Progress value={signalDNA.confidence} className="h-1.5 bg-gray-800" />
                <div 
                  className={`absolute inset-0 h-1.5 bg-gradient-to-r ${confidenceLevel.color} rounded-full transition-all duration-1000`}
          ...
          <CardContent className="space-y-4 relative z-10">
            {/* Trading Levels */}
            <div className="bg-black/30 rounded border border-gray-700/50 p-4 font-mono">
              <div className="grid grid-cols-3 gap-4 text-center text-sm">
                <div>
                  <div className="text-gray-400 mb-1 font-serif">ENTRY</div>
                  <div className="text-white font-bold">{signalDNA.structure.entry}</div>
                </div>
                <div>
                  <div className="text-gray-400 mb-1 font-serif">STOP</div>
                  <div className="text-red-400 font-bold">{signalDNA.structure.stopLoss}</div>
                </div>
                <div>
                  <div className="text-gray-400 mb-1 font-serif">TARGET</div>
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded p-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-green-400 font-serif">Live Price</span>
                </div>
            ...
            <div className="bg-gray-800/30 rounded p-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-blue-400 font-serif text-sm">Technical Confluence</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gray-700/20 rounded p-2 text-center">
                <p className="text-gray-400 text-xs mb-1 font-serif">Session</p>
                <p className="text-pink-300 font-bold text-sm">{signalDNA.session}</p>
              </div>
              <div className="bg-gray-700/20 rounded p-2 text-center">
                <p className="text-gray-400 text-xs mb-1 font-serif">Timeframe</p>
                <p className="text-orange-300 font-bold text-sm">{signalDNA.timeframe}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-pink-500/30 text-pink-400 hover:bg-pink-500/20 font-serif"
              >
                {isUpdating ? (
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-blue-500/30 text-blue-400 hover:bg-blue-500/20 font-serif"
              >
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-purple-500/30 text-purple-400 hover:bg-purple-500/20 font-serif"
              >
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-yellow-500/30 text-yellow-400 hover:bg-yellow-500/20 font-serif"
              >
            ...
            {/* Timestamp */}
            <div className="text-xs text-gray-500 text-center font-serif flex items-center justify-center gap-1">
