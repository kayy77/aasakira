  ...
  return (
    <div className="space-y-6">
        ...
        <CardHeader className="relative z-10">
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-playfair font-bold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent samurai-text">
                  ⛩️ AASAKIRA SIGNAL SYSTEM
                </h2>
                <p className="text-sm text-gray-400 tactical-text">
                  Silent precision. Disciplined execution. Every signal is a calculated strike.
                </p>
                <div className="flex items-center gap-4 mt-2">
                  <Badge className="bg-green-500/20 text-green-400 border-green-500/30 text-xs font-playfair glow-soft">
                    <Activity className="w-3 h-3 mr-1" />
                    LIVE FEEDS ACTIVE
                  </Badge>
                  <Badge className="bg-pink-500/20 text-pink-400 border-pink-500/30 text-xs font-playfair glow-soft">
                    <Shield className="w-3 h-3 mr-1" />
                    AI COUNCIL ONLINE
                  </Badge>
                  <Badge className="bg-purple-500/20 text-purple-400 border-purple-500/30 text-xs font-playfair glow-soft">
            ...
            <div className="flex items-center gap-2">
              {lastUpdate && (
                <div className="flex items-center gap-1 text-xs text-gray-400 font-playfair">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-blue-500/30 hover:bg-blue-500/20 text-blue-400 font-playfair glow-soft elite-button"
              >
              ...
              <Button
                ...
                className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 text-pink-400 border border-pink-500/50 hover:bg-pink-500/30 font-playfair font-bold glow-intense elite-button"
              >
                {isGenerating ? (
                  <>
      ...
      <Card className="bg-gray-950/50 border-gray-600/30 glow-soft animate-section-load">
        <CardHeader>
          <CardTitle className="text-white flex items-center gap-2 font-playfair samurai-text">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <label className="text-sm text-gray-400 mb-1 block font-playfair">Strategy Type</label>
              <select 
                value={generationSettings.strategyType}
                onChange={(e) => setGenerationSettings(prev => ({ ...prev, strategyType: e.target.value as any }))}
                className="w-full elite-select rounded px-3 py-2 text-sm glow-soft"
              >
            ...
            <div>
              <label className="text-sm text-gray-400 mb-1 block font-playfair">Min Confidence</label>
              <select 
            ...
            <div>
              <label className="text-sm text-gray-400 mb-1 block font-playfair">Min Confluence</label>
              <select 
            ...
            <div>
              <label className="text-sm text-gray-400 mb-1 block font-playfair">Pair Filter</label>
              <select 
      ...
      {militarySignals.length > 0 && (
        <Alert className="border-green-500/30 bg-gradient-to-r from-green-500/10 to-emerald-500/10 glow-soft animate-section-load">
          ...
          <AlertDescription className="text-green-400 font-playfair">
            ⛩️ AASAKIRA SYSTEM OPERATIONAL - {militarySignals.length} Active Signals | Auto-refresh: 5s intervals
            <div className="mt-1 text-xs text-green-300 tactical-text">
      ...
      {militarySignals.length === 0 && !isGenerating && (
        <Card className="bg-gradient-to-br from-gray-950 to-gray-900 border-gray-500/20 glow-soft animate-section-load">
          <CardContent className="text-center py-12">
            ...
            <h3 className="text-2xl font-playfair font-bold text-white mb-2 samurai-text">⛩️ SYSTEM STANDBY</h3>
            <p className="text-gray-400 mb-6 max-w-md mx-auto tactical-text">
              Multi-Intelligence Core awaiting deployment. Elite signals require AI council consensus of 4/6 minimum.
            </p>
            <Button
              onClick={generateMilitarySignal}
              className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 text-pink-400 border border-pink-500/50 hover:bg-pink-500/30 font-playfair font-bold px-8 py-3 glow-intense elite-button"
            >
              <Brain className="w-5 h-5 mr-2" />
