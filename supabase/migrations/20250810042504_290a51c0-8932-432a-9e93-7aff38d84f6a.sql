...
CREATE INDEX idx_signals_confluence_bucket ON public.signals(confluence_bucket);
...
CREATE INDEX idx_consensus_audit_signal_id ON public.consensus_audit(signal_id);
CREATE INDEX idx_consensus_audit_created_at ON public.consensus_audit(created_at DESC);
CREATE INDEX idx_consensus_audit_provider ON public.consensus_audit(provider_name);
